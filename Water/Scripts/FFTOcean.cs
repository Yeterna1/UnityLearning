...
public class FFTOcean : MonoBehaviour
{
    ...
    public Material gaussianRandomMat; //高斯随机数贴图
    [Range(0, 12)]
    ...
    private void InitializeCSvalue()
    {
        ...
        {
            Debug.Log("GaussianRandomRT is not null && isCreated");
        ...
        gaussianRandomMat.SetTexture("_MainTex", GaussianRandomRT);
    ...
    {
        //设置海洋材质纹理
        OceanMaterial.SetTexture("_WaterSurfaceDisplace", DisplaceRT);
        OceanMaterial.SetTexture("_WaterSurfaceNormal", NormalRT);
        OceanMaterial.SetTexture("_WaterSurfaceBubbles", BubblesRT);
